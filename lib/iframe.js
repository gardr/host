...
Iframe.prototype.makeIframe = function() {
    ...
    /*  Adding iframe.name is a workaround for cache-content errors in chrome:
        - https://code.google.com/p/chromium/issues/detail?id=395791
        - https://code.google.com/p/chromium/issues/detail?id=324102
        Data-transport-fallback using iframe.name will not conflict, as unique value are needed.
        The value needs to be unqiue, or else chrome might decide to reuse content from previous runs.
        - because this fix only applies to chrome, the IE-data-transport-fallback payload does not need to be unique.
    */
